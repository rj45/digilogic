...
SRCS = src/core/circuit.c src/ux/ux.c src/ux/input.c src/ux/undo.c src/ux/autoroute.c src/view/view.c src/import/digital.c src/autoroute/autoroute.c src/core/timer.c src/core/smap.c
