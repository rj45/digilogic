...
THIRDPARTY_LIBS = thirdparty/adaptagrams/libavoid.a thirdparty/routing/target/release/libdigilogic_routing.a
...
LIBFLAGS = -fobjc-arc -framework Metal -framework Cocoa -framework MetalKit -framework Quartz \
	-Lthirdparty/adaptagrams -Lthirdparty/routing/target/release -lavoid -lstdc++
