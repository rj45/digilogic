...
MAIN_SRCS = $(SRCS) src/main.c src/apple.m src/assets.c src/render/fons_sgp.c src/render/sokol_nuklear.c src/render/fons_nuklear.c src/render/polyline.c src/render/draw.c src/ui/ui.c src/ui/loadsave.c
